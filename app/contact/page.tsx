...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-peachpuff">
      <Navbar ContactPage />
      <motion.div
        className="bg-peachpuff px-[30px] pb-[30px] sm:px-[90px] sm:pb-[60px] md:py-[140px] md:pb-[60px]    h-screen"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="mb-20 sm:mb-28  mx-auto self-center my-auto  top-[30%] w-[min(100%,38rem)] text-center">
          <h1 className="py-3 mb-2 text-[25px] sm:text-[35px] font-normal font-poppins ">
            Contact Me
          </h1>
