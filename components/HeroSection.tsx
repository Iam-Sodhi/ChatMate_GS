...
const HeroSection: React.FC<HeroSectionProps> = () => {
  ...
  return (
   <>
    <Navbar />
    <section className="section block  bg-peachpuff  sm:pt-[18vh]  sm:min-h-screen text-left text-[1.13rem] text-white font-roboto">
      <div className="container block mx-auto max-w-[1160px]">
        <div className="flexbox flex flex-col  items-start sm:flex-row sm:justify-center justify-between sm:items-center">
          <div className="left-block mb-5 sm:mb-0   sm:mr-[30px] md:mr-[60px] md:min-w-[340px] sm:min-w-[280px] sm:max-w-[345px] lg:max-w-[500px] sm:min-h-[341.22px]  ">
           ...
           animate={{opacity:1}}
           transition={{delay:0.1}}><motion.span
