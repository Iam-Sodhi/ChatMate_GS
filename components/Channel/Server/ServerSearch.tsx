...
const ServerSearch:React.FC<ServerSearchProps> = ({
    ...
    return (
        ...
        >
          ...
          <kbd
            className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted p-1.5 font-mono bg-white dark:bg-[#1E1F22] text-black dark:text-white text-[10px] font-medium text-muted-foreground ml-auto"
